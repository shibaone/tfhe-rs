    ...
    (
        ...
        impl $type_name {
            ...
            pub fn safe_deserialize(buffer: &[u8], serialized_size_limit: u64) -> Result<$type_name, JsError> {
                catch_panic_result(|| {
                    crate::safe_serialization::DeserializationConfig::new_without_conformance(serialized_size_limit)
...
impl CompactCiphertextList {
    ...
    pub fn safe_deserialize(
        ...
        catch_panic_result(|| {
            crate::safe_serialization::DeserializationConfig::new_without_conformance(
